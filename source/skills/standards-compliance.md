...
- Flag when a 504 plan is being used where an IEP may be more appropriate (student is significantly behind academically).
- Note that state laws may add requirements beyond federal minimums — advise users to check their state's dyslexia mandate.
